...
const Sidebar: React.FC<SidebarType> = ({ isOpen }) => {
  return (
    <div className="w-[95%] mr-4 md:mr-0 relative sm:w-[93%] h-[90%]  mt-10  rounded-2xl bg-white flex items-center  mx-auto">
      {isOpen ? (
        <div className="block md:hidden duration-700  w-[50%] absolute left-0 top-0 h-screen z-50  bg-white">
